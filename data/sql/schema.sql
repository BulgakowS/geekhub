...
CREATE TABLE sf_guard_user (id BIGINT AUTO_INCREMENT, first_name VARCHAR(255), last_name VARCHAR(255), subj_of_law_id BIGINT, phone VARCHAR(255) UNIQUE, description TEXT, email_address VARCHAR(255) NOT NULL UNIQUE, username VARCHAR(128) NOT NULL UNIQUE, algorithm VARCHAR(128) DEFAULT 'sha1' NOT NULL, salt VARCHAR(128), password VARCHAR(128), is_active TINYINT(1) DEFAULT '1', is_super_admin TINYINT(1) DEFAULT '0', last_login DATETIME, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX is_active_idx_idx (is_active), INDEX subj_of_law_id_idx (subj_of_law_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE photos ADD CONSTRAINT photos_objects_id_objects_id FOREIGN KEY (objects_id) REFERENCES objects(id) ON DELETE CASCADE;
...
ALTER TABLE sf_guard_user ADD CONSTRAINT sf_guard_user_subj_of_law_id_subj_of_law_id FOREIGN KEY (subj_of_law_id) REFERENCES subj_of_law(id);
