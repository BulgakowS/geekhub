...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'subj_of_law_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Subj'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'subj_of_law_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Subj'), 'column' => 'id')),
